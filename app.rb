...
get '/rodbot' do
  post_gif params[:channel_id]
  status 200
end

def post_gif channel
  slack_url = ENV['SLACK_WEBHOOK_URL']
  HTTParty.post slack_url, body:
    {'text' => random_gif,
    'username' => 'Rodbot',
...
def random_gif
  all_gifs[rand(all_gifs.length)]
end

all_gifs = ['http://67.media.tumblr.com/6b5110cd7d7ca17b3210b3d4d89232d3/tumblr_oca4sreR4Z1rscte8o1_500.gif',
